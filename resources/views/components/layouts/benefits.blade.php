<div>
    <div
        ...
        <div class="relative pb-10">
            ...
            <p
                class="w-full max-w-xl mx-auto mt-4 mb-0 text-sm font-medium leading-relaxed text-center text-neutral-400 border-0 border-primary-200 lg:text-lg md:text-base">
        ...
        <div class="z-10 grid gap-5 md:grid-cols-6 lg:grid-cols-9">
            <!-- Feature 1 -->
            <div class="col-span-3 text-neutral-700 bg-primary-50 rounded-3xl" data-rounded="rounded-3xl"
                ...
                <div
                    ...
                    <div class="flex-shrink-0 p-3 text-neutral-700 border border-neutral-200 rounded-full"
                        data-rounded="rounded-full">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="leading-6 text-center text-neutral-700 align-middle stroke-current w-7 h-7"
                    ...
                    <div class="mt-4 text-left text-neutral-700 border-0 border-primary-200 sm:mt-2 sm:ml-4">
                        <h6 class="box-border text-2xl font-bold leading-none tracking-wide text-left border-solid">
                            Ausbalancierte Energie</h6>
                        <p
                            class="box-border mx-0 mt-1 mb-0 font-medium leading-loose text-neutral-400 border-solid sm:mt-4">
            ...
            <div class="col-span-3 text-neutral-700 bg-primary-50 rounded-3xl" data-rounded="rounded-3xl"
                ...
                <div
                    class="box-border flex flex-col items-start h-full px-2 py-8 mx-4 leading-6 text-center border-solid sm:flex-row sm:items-start sm:text-left">
                    <div class="flex-shrink-0 p-3 text-neutral-700 border border-primary-200 rounded-full"
                        data-rounded="rounded-full">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="leading-6 text-center text-neutral-700 align-middle stroke-current w-7 h-7"
                            width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50"
            ...
            <!-- Feature 6 -->
            <div class="col-span-3 text-neutral-700 border-0 bg-primary-50 rounded-3xl" data-rounded="rounded-3xl"
                data-rounded-max="rounded-full">
                <div
                    class="box-border flex flex-col items-start h-full px-2 py-8 mx-4 leading-6 text-center border-solid sm:flex-row sm:items-start sm:text-left">
                    <div class="flex-shrink-0 p-3 text-neutral-700 border border-primary-200 rounded-full"
